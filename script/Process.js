class Process {
            ...
            success: function(response){
                ...
                self.tableDisplay = new Tabulator(tableElem, {
                    ...
                    columns: [
                        ...
                        {title: "DESCRIPTION", field: "PROCESS_DESC", headerFilter: "input"},
    ...
    SetRecord(record){
        $.ajax({
            url: "php/controllers/Process/GetRecord.php",
            method: "POST",
            data: {
                id: record.id,
            },
            ...
            success: function(data){
                ...
                record.desc.val(data.PROCESS_DESC);
    ...
    InsertRecord(record){
        ...
        if(desc.val() == ""){
            ...
            $.ajax({
                url: "php/controllers/Process/InsertRecord.php",
                method: "POST",
                data: {
                    desc: desc.val(),
                },
    ...
    UpdateRecord(record){
        ...
        if(desc.val() == ""){
            ...
            $.ajax({
                url: "php/controllers/Process/UpdateRecord.php",
                method: "POST",
                data: {
                    desc: desc.val(),
                    id: id.val(),
    ...
    RemoveRecord(record){
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: 'php/controllers/Process/RemoveRecord.php', // Replace with your server-side script URL
                    type: 'POST',
                    data: {
                        id: record.id,
                    },
